...
-- BS. Nguyễn Văn A (Tim mạch) – làm chiều T3, T5
INSERT INTO doctor_schedule_templates (id, doctor_id, day_of_week, from_time, to_time, slot_duration, updated_at) VALUES
('d50e8400-e29b-41d4-a716-446655440101', '750e8400-e29b-41d4-a716-446655440017', 'TUESDAY',   '14:00:00', '20:00:00', 30, NOW()),
('d50e8400-e29b-41d4-a716-446655440102', '750e8400-e29b-41d4-a716-446655440017', 'THURSDAY',  '14:00:00', '20:00:00', 30, NOW());

-- BS. Trần Thị Ngọc Anh (Sản phụ khoa) – làm T2, T4, T6
INSERT INTO doctor_schedule_templates (id, doctor_id, day_of_week, from_time, to_time, slot_duration, updated_at) VALUES
('d50e8400-e29b-41d4-a716-446655440103', '750e8400-e29b-41d4-a716-446655440018', 'MONDAY',    '08:00:00', '17:00:00', 45, NOW()),
('d50e8400-e29b-41d4-a716-446655440104', '750e8400-e29b-41d4-a716-446655440018', 'WEDNESDAY', '08:00:00', '17:00:00', 45, NOW()),
('d50e8400-e29b-41d4-a716-446655440105', '750e8400-e29b-41d4-a716-446655440018', 'FRIDAY',    '08:00:00', '12:00:00', 45, NOW());

-- BS. Phạm Minh Đức (Nhi khoa) – làm sáng T2-T6
INSERT INTO doctor_schedule_templates (id, doctor_id, day_of_week, from_time, to_time, slot_duration, updated_at) VALUES
('d50e8400-e29b-41d4-a716-446655440106', '750e8400-e29b-41d4-a716-446655440019', 'MONDAY',    '07:30:00', '11:30:00', 20, NOW()),
('d50e8400-e29b-41d4-a716-446655440107', '750e8400-e29b-41d4-a716-446655440019', 'TUESDAY',   '07:30:00', '11:30:00', 20, NOW()),
('d50e8400-e29b-41d4-a716-446655440108', '750e8400-e29b-41d4-a716-446655440019', 'THURSDAY',  '07:30:00', '11:30:00', 20, NOW());

-- BS. Hoàng Thị Kim Liên (Da liễu) – làm chiều T3, T5, T7
INSERT INTO doctor_schedule_templates (id, doctor_id, day_of_week, from_time, to_time, slot_duration, updated_at) VALUES
('d50e8400-e29b-41d4-a716-446655440109', '750e8400-e29b-41d4-a716-446655440020', 'TUESDAY',   '13:00:00', '19:00:00', 30, NOW()),
('d50e8400-e29b-41d4-a716-446655440110', '750e8400-e29b-41d4-a716-446655440020', 'THURSDAY',  '13:00:00', '19:00:00', 30, NOW()),
('d50e8400-e29b-41d4-a716-446655440111', '750e8400-e29b-41d4-a716-446655440020', 'SATURDAY',  '08:00:00', '12:00:00', 30, NOW());

-- Thêm vài bác sĩ nữa cho đa dạng (tùy thích bỏ bớt)
INSERT INTO doctor_schedule_templates (id, doctor_id, day_of_week, from_time, to_time, slot_duration, updated_at) VALUES
('d50e8400-e29b-41d4-a716-446655440112', '750e8400-e29b-41d4-a716-446655440021', 'MONDAY',    '14:00:00', '20:00:00', 60, NOW()),
('d50e8400-e29b-41d4-a716-446655440113', '750e8400-e29b-41d4-a716-446655440024', 'WEDNESDAY', '08:00:00', '17:00:00', 45, NOW()),
('d50e8400-e29b-41d4-a716-446655440114', '750e8400-e29b-41d4-a716-446655440026', 'FRIDAY',    '15:00:00', '19:00:00', 30, NOW());
-- =====================================================
-- CLINIC SPECIALTY SCHEDULE TEMPLATES (Lịch hoạt động của chuyên khoa tại phòng khám)
-- =====================================================
